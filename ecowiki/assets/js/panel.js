...
const PATCHstartup = async () => {
  ...
  const res = await patchData("http://localhost:3000/api/startups/", id, data).catch(e => { console.log(e); alert("Something went wrong"); });
  alert("Success");
  return res;
}
...
const PATCHgroup = async () => {
  ...
  const res = await patchData("http://localhost:3000/api/groups/", id, data).catch(e => { console.log(e); alert("Something went wrong"); });
  alert("Success");
  return res;
}
...
const PATCHorg = async () => {
  ...
  const res = await patchData("http://localhost:3000/api/organizations/", id, data).catch(e => { console.log(e); alert("Something went wrong"); });
  alert("Success");
  return res;
}
...
const PATCHinfluencer = async () => {
  ...
  const res = await patchData("http://localhost:3000/api/influencers/", id, data).catch(e => { console.log(e); alert("Something went wrong"); });
  alert("Success");
  return res;
}
