...
router.get("/oauth",(req,res)=>{res.redirect("https://secure.meetup.com/oauth2/authorize?client_id=q31qm95rop67fmmcul0v9ta5id&response_type=code&redirect_uri=http://localhost:3000/api/meetup/www.wikiai.com")});
